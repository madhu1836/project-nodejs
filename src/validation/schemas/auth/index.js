...
module.exports = {
	...
	signup: Joi.object().keys({
		user_name: Joi.string().regex(/^[a-zA-Z. ]*$/).required().error(new Error('User first name should not contain any spacial characters and numbers!')),
		user_last_name: Joi.string().regex(/^[a-zA-Z. ]*$/).error(new Error('User last name should not contain any spacial characters and numbers!')),
		em_phone: Joi.string().min(3).required().label('Phone or Email'),
